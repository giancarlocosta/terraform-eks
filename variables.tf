...
variable "ssh_keypair_name" {
  description = "Keypair to use for SSHing to worker nodes."
  type        = "string"
}

variable "external_access_cidrs" {
  description = "List of cidrs to open masters Security Group access to the Kubernetes cluster "
  type        = "list"
}
...
variable "workers_group_defaults" {
  ...
  default = {
    ...
    root_volume_size     = "128"         # root volume size of workers instances
    root_volume_type     = "gp2"         # root volume type of workers instances, can be 'standard', 'gp2', or 'io1'
    root_iops            = "0"           # The amount of provisioned IOPS. This must be set with a volume_type of "io1".
    labels               = ""            # Separated by semicolon! (E.g. label1=1;label2=2) --> AWS Tag Key = "k8snode/labels" and AWS Tag Value = "label1=1;label2=2"
    taints               = ""            # Separated by semicolon! (E.g. taint1=1:NoSchedule;taint1=2:NoSchedule) --> AWS Tag Key = "k8snode/taints" and AWS Tag Value = "taint1=1:NoSchedule;taint1=2:NoSchedule"
  }
}
